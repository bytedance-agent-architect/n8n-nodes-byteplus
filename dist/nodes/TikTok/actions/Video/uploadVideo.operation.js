...
async function execute(index) {
    var _a, _b, _c, _d;
    const videoSource = this.getNodeParameter('videoSource', index);
    const title = this.getNodeParameter('title', index);
    const additionalOptions = this.getNodeParameter('additionalOptions', index, {});
    const privacyLevel = additionalOptions.privacyLevel || 'PUBLIC_TO_EVERYONE';
    ...
    if (videoSource === 'url') {
        ...
        initBody.source_info.source = 'FILE_UPLOAD';
        initBody.source_info.video_size = fileSize;
        initBody.source_info.chunk_size = fileSize;
        initBody.source_info.total_chunk_count = 1;
    }
    else {
    ...
    try {
        ...
        if (((_b = (_a = initResponse.body) === null || _a === void 0 ? void 0 : _a.error) === null || _b === void 0 ? void 0 : _b.code) === 'access_token_invalid') {
        ...
        try {
            ...
            throw new Error(`TikTok API error: ${error.message}. Refresh also failed: ${refreshError.message}`);
        }
    }
    // Handle errors
    ...
    const publishId = (_c = initResponse.data) === null || _c === void 0 ? void 0 : _c.publish_id;
    const uploadUrl = (_d = initResponse.data) === null || _d === void 0 ? void 0 : _d.upload_url;
    ...
    return {
        ...
        details: {
            ...
            privacyLevel,
            videoSource,
            videoSize: videoBuffer === null || videoBuffer === void 0 ? void 0 : videoBuffer.length,
        },
    };
}
//# sourceMappingURL=uploadVideo.operation.js.map