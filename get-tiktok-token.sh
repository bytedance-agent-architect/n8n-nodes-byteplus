...
read -r -p "Enter your TikTok Client Key: " CLIENT_KEY
read -r -s -p "Enter your TikTok Client Secret: " CLIENT_SECRET
echo ""
read -r -p "Enter your Redirect URI (e.g., https://your-url.com/callback): " REDIRECT_URI
...
echo ""
read -r -s -p "Paste the code here: " AUTH_CODE
echo ""
